    ...
    <div class="bar">
      <label for="sort">Sort mail:</label>
          ...
          <div class="search-filter">
            ...
            <div class="dropdown">
              <button id="filter" style="text-align: center;" @click="showFilterSent()"><img src="..\assets\images\filter.svg"></button>
              <div class="dropdown-content" id="search-sent">
                <form>
                  <label for="to" style="font-size: 17px; margin-left: 10px;margin-right: 42px;">To:</label>
                  <input type="text" id="to" placeholder="To" v-model="filterTo" >
                </form>
                <form>
...
export default {
  ...
  methods: {
    ...
    ,sort(){
      ...
      ,filter(){
        this.hideFilterSent()
        if(this.filterTo != '' || this.filterSubject != ''){
          this.emitter.emit("filter",{msg1: this.filterTo , msg2: this.filterSubject})
        }
      }
      ,Delete(){
