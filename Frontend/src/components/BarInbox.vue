<template>
    <div class="bar">
      <label for="sort">Sort mail:</label>
          <select name="Sort" id="sort" v-model="sortby" @change="sort()">
          ...
          <div class="search-filter">
            ...
            <div class="dropdown">
              <button id="filter" style="text-align: center;" @click="showFilterInbox()"><img src="..\assets\images\filter.svg"></button>
              <div class="dropdown-content" id="search-inbox">
                <form>
  ...
  methods: {
    ...
    ,hideFilterInbox() {
     ...
     ,sort(){
      ...
      ,filter(){
        this.hideFilterInbox()
        console.log('before:'+this.filterSubject)
        if( this.filterFrom != '' || this.filterSubject != ''){
          console.log('after:'+this.filterSubject)
