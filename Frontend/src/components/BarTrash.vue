    ...
    <div class="bar">
      <label for="sort">Sort mail:</label>
          ...
          <div class="search-filter">
            ...
            <div class="dropdown">
              <button id="filter" style="text-align: center;" @click="showFilterTrash()"><img src="..\assets\images\filter.svg"></button>
              <div class="dropdown-content" id="search-trash">
                <form>
